...
async function createDb() {
  const dbUrl = process.env.DATABASE_URL || 'postgresql://postgres:2007@localhost:5432/Nova';
  ...
  try {
    ...
    console.log('Using default fallback connection settings to check/create database.');
  }

  console.log(`Connecting to Postgres default system database to verify/create database: "${dbName}"...`);
